<template>
  <inertia-head>
    <title head-key="title">
      Сервис отзывов на арендное жильё в Гродно - Rent Ratings
    </title>
    <meta
      name="description"
      content="Просматривай отзывы на квартиры или другое арендное жильё. Делись своим опытом проживания в нём. Rent Ratings помогает не ошибиться при выборе жилья."
    >
  </inertia-head>
  <r-header
  ...
  <section class="relative -mt-7 flex flex-col">
    ...
    <r-info-card
      ...
      :img="MapImage"
      description="Введи адрес дома, найди интересующую квартиру и посмотри отзывы на неё. Если отзывов нет, вы можете его написать 😉"
...
const aboutCardArray = [
  ...
  },
  {
    ...
    description: 'Поделись впечатлениями о проживании в квартире. Будущие арендаторы будут очень благодарны!',
    img: CatImage,
    theme: InfoCardTheme.blue,
  },
  {
